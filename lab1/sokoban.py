...
def read_command( argv ):
    ...
    EXAMPLES:   python sokoban.py --agent DFS --grid puzzle1.txt
                OR  python sokoban.py -a DFS -g puzzle1.txt
                    - solve puzzle1 with the naive path finder
    """
    ...
    parser.add_option('-g', '--grid', dest = 'grid',
                      help = 'The grid to solve', default = 'puzzle1.txt')
