...
class Reversi:
    def __init__( self, player1, player2, moves, function = None ):
    ...
    def run( self ):
        ...
        """
        f = ReversiFrame(self.__player1, self.__player2)
        f.mainloop()

def run_agents( player1, player2, timeout, mute, function = None ):
    """ The real main. """
    reversi = Reversi(player1, player2, function)
    reversi.run()
